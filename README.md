...
This project takes data from UCI Har Dataset and puts it into two clean datasets.  The following is an expert from the experiment website about the experiment: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
